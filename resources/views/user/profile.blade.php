            ...
            <div class="col-12 grid-margin">
              <div class="profile-header">
                <div class="cover">
                  ...
                  <figure>
                    <img src="{{ asset('tmp/assets/images/profile-cover.jpg') }}" class="img-fluid" alt="profile cover">
                  </figure>
                  <div class="cover-body d-flex justify-content-between align-items-center">
                    <div>
                      <img class="profile-pic" src="{{ asset('tmp/assets/images/faces/face1.jpg') }}" alt="profile">
                ...
                <div class="col-md-12 grid-margin">
                  <div class="card rounded">
                    <div class="card-header">
                      <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                          <img class="img-xs rounded-circle" src="{{ asset('tmp/assets/images/faces/face1.jpg') }}" alt="">                         
                          <div class="ml-2">
                            <p>Mike Popescu</p>
                    ...
                    <div class="card-body">
                      ...
                      <img class="img-fluid" src="{{ asset('tmp/assets/images/sample1.jpg') }}" alt="">
                    </div>
                ...
                <div class="col-md-12">
                  <div class="card rounded">
                    ...
                    <div class="card-body">
                      ...
                      <img class="img-fluid" src="{{ asset('tmp/assets/images/sample2.jpg') }}" alt="">
                    </div>
                    <div class="card-footer">
                      <div class="d-flex post-actions">
                        <a href="javascript:;" class="d-flex align-items-center text-muted mr-4">

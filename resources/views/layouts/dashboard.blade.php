...
<head>
  ...
  <!-- plugin css for this page -->
    <link rel="stylesheet" href="{{ asset('tmp/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css') }}"></div>
  ...
  <!-- End layout styles -->
  <link rel="shortcut icon" href="{{ asset('tmp/assets/images/favicon.png') }}" />

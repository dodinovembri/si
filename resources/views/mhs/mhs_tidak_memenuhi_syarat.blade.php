      ...
      <div class="page-content">
        ...
        <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Mahasiswa Tidak Memenuhi Syarat</li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">List Mahasiswa Tidak Memenuhi Syarat</h6>                
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      <?php $no=0; foreach ($mhs_tidak_memenuhi_syarat as $key => $value) { $no++; ?>
                          <tr>
                            <td>{{ $no }}</td>
                            <td>{{ $value->nim }}</td>
                            <td>{{ $value->nama }}</td>
